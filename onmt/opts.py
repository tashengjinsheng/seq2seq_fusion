...
def model_opts(parser):
    ...
    group.add('--cue_encoder_type', '-cue_encoder_type', type=str, default='cue_brnn',
              choices=['cue_rnn', 'cue_brnn'],
              help="Type of cue encoder layer to use. Non-RNN layers "
                   "are experimental. Not like the parameter encoder_type, here only cue_rnn"
                   "and cue_brnn mapping to knowledge encoder Options are "
                   "[cue_rnn|cue_brnn].")
    ...
    group.add('--rnn_size', '-rnn_size', type=int, default=800,
...
def preprocess_opts(parser):
    ...
    group.add('--train_cue','-train_cue', required=True, nargs='+',
    ...
    group.add('--overwrite', '-overwrite', action="store_true", default=True,
    ...
    group.add('--src_vocab', '-src_vocab', default="",
              help="Path to an existing source vocabulary. Format: "
                   "one word per line.")
    group.add('--cue_vocab', '-cue_vocab', default="",
              help="Path to an existing source vocabulary. Format: "
                   "one word per line.")
    ...
    group.add('--src_vocab_size', '-src_vocab_size', type=int, default=30000,
              help="Size of the source vocabulary")
    group.add('--cue_vocab_size', '-cue_vocab_size', type=int, default=30000,
              help="Size of the source vocabulary")
    group.add('--tgt_vocab_size', '-tgt_vocab_size', type=int, default=30000,
    ...
    group.add('--cue_words_min_frequency',
              '-cue_words_min_frequency', type=int, default=0)
    ...
    group.add('--src_seq_length', '-src_seq_length', type=int, default=250,
              help="Maximum source sequence length")
    group.add('--src_seq_length_trunc', '-src_seq_length_trunc',
              type=int, default=None,
              help="Truncate source sequence length.")
    group.add('--cue_seq_length', '-cue_seq_length', type=int, default=50,
              help="Maximum knowledge sequence length")
    group.add('--cue_seq_length_trunc', '-cue_seq_length_trunc', type=int,default=None,
              help='Truncate knowledge sentence length')
...
def train_opts(parser):
    ...
    group.add('--pre_word_vecs_cue', '-pre_word_vecs_cue',
              help="If a valid path is specified, then this will load "
                   "pretrained word embeddings on the knowledge encoder side. "
                   "See README for specific formatting instructions.")
    ...
    group.add('--fix_word_vecs_cue', '-fix_word_vecs_cue',
              action='store_true',
              help="Fix word embeddings on the knowledge encoder side.")
    ...
    group.add('--batch_size', '-batch_size', type=int, default=4,
    ...
    group.add('--valid_steps', '-valid_steps', type=int, default=2500,
    ...
    group.add('--train_steps', '-train_steps', type=int, default=200000,
    ...
    group.add('--early_stopping', '-early_stopping', type=int, default=200,
    ...
    group.add('--learning_rate', '-learning_rate', type=float, default=0.0005,
    ...
    group.add('--start_decay_steps', '-start_decay_steps',
              ...
              help="Start decaying every decay_steps after "
                   "start_decay_steps")
    group.add('--decay_steps', '-decay_steps', type=int, default=2500,
...
def translate_opts(parser):
    ...
    group.add('--src', '-src', required=True,
              help="Source sequence to decode (one line per "
                   "sequence)")
    group.add('--cue', '-cue', required=True,
              help="Source knowledge sequences to decode (one line per "
                   "sequence)")
    group.add('--src_dir', '-src_dir', default="",
              help='Source directory for image or audio files')
    group.add('--tgt', '-tgt',
    ...
    group.add('--report_time', '-report_time', action='store_true',default=True,
